      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 sm:py-16">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Start free. Pay only when you grow. All plans include white-labeled pages, bank payout settings, and payment processing.
          </p>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto grid max-w-4xl gap-8 sm:grid-cols-3">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold">Bank payout settings</h3>
              <p className="mt-2 text-sm text-muted-foreground">
                Configure your bank details to receive payouts directly. Available on all plans.
              </p>
            </div>
            <div className="flex flex-col items-center text-center">
              <div className="mb-4 flex size-12 items-center justify-center rounded-xl bg-primary/10">
