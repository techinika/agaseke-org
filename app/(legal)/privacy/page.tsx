...
export default function PrivacyPage() {
  logger.info('page:privacy', 'Rendering Privacy Policy page');
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8 sm:py-16">
          ...
          <div className="mt-10 space-y-8 text-sm leading-relaxed text-foreground/80">
            ...
            <section>
              ...
              <p>
                We use Firebase (Google) for authentication, database, and storage. We use PesaPal for payment processing and Cloudflare R2 for image storage. These services have their own privacy policies.
              </p>
            </section>
